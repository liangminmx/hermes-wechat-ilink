#!/bin/bash
# 🚀 Hermes WeChat iLink 安装脚本 v2.0.3
# 针对Debian/Ubuntu 23.10+系统修复

echo "=================================================="
echo "🚀 Hermes WeChat iLink Plugin v2.0.3"
echo "🔧 Debian/Ubuntu 23.10+ 兼容版本"
echo "=================================================="
